...
bot.on('message', function(event) {
    switch (event.message.type) {
        case 'text':
            ...
            if ((event.message.text.indexOf('掛') != -1 || event.message.text.indexOf('請') != -1 || event.message.text.indexOf('hr') != -1) && (event.message.text.indexOf(' off') != -1 || event.message.text.indexOf('小時') != -1)) {
